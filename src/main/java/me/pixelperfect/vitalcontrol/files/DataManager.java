package me.pixelperfect.vitalcontrol.files;
...
public class DataManager {
    ...
    private final VitalControl plugin;
    private FileConfiguration dataConfig = null;
    private File configFile = null;


    public DataManager(VitalControl plugin) {this.plugin = plugin; saveDefaultConfig();}
